...
//        });
        ...
        function initResize() {
            ...
            if (_width <= 768) {
                ...
                //gnavi
                $('.commonNavWrap01 .store,.commonNavWrap01 .service').addClass("none-submenu");
                $('.commonNavWrap01 .store,.commonNavWrap01 .service').removeClass("active-submenu");
                $('.commonNavWrap01 .store + .acoCont,.commonNavWrap01 .service + .acoCont').css({"display":"none"});
//                //mypage
...
//                  $(".add-tyo-cart").css("margin-left", "-" + divW / 2 + "px");
                //gnavi
                $('.commonNavWrap01 .store,.commonNavWrap01 .service').removeClass("none-submenu");
                $('.commonNavWrap01 .store,.commonNavWrap01 .service').addClass("active-submenu");
                $('.commonNavWrap01 .store + .acoCont,.commonNavWrap01 .service + .acoCont').css({"display":"block"});
                //mypage
//                $('.myPageContainer .menuArea li a').tile();
                // change
